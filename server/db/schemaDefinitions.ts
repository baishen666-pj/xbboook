 ...
 * Both production migrations and test helpers import from this file
...
CREATE INDEX IF NOT EXISTS foreshadowing_project_status_idx ON foreshadowing(project_id, status);
...
/**
 * Post-schema ALTER statements for incremental migrations.
 * These run after the base schema to add columns that were added in later phases.
 */
export const POST_SCHEMA_ALTER_SQL = `
ALTER TABLE projects ADD COLUMN daily_target INTEGER DEFAULT 0;
`;
