...
export function ChapterItem({ chapter, isActive, onClick, onReorder, isSelectMode }: ChapterItemProps) {
  ...
  return (
    <div
      ref={dragRef}
      draggable={!!onReorder && !isSelectMode}
    ...
    >
      ...
      <button
        ...
        className={[
          ...
          onReorder && !isSelectMode ? "cursor-pointer" : "",
        ].join(" ")}
      >
        {isSelectMode && (
          <span
